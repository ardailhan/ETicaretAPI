...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                .AddJwtBearer("Admin", options =>
                {
                    options.TokenValidationParameters = new()
                    {
                        ...
                        NameClaimType = ClaimTypes.Name  //JWT üzerinde claimine karşılık gelen değeri User.Identity.Name propertysinden elde edebiliriz.
                    };
                });
...
app.ConfigureExceptionHandler<Program>(app.Services.GetRequiredService<ILogger<Program>>());  //Global exception middleware.
app.UseStaticFiles();
